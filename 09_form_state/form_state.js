    ...
    return (
      <form action="" method="get" className="container">
        ...
        <div>
          ...
          <input type="radio" name="gender" id="gender1" value="Man" checked={this.state.gender === "Man"} onChange={this.handleInputChange} />
          <label htmlFor="gender1">Man</label>

          <input type="radio" name="gender" id="gender2" value="Woman" checked={this.state.gender === "Woman"} onChange={this.handleInputChange} />
