      ...
      <div className="container">
        <form onSubmit={this.handleFormSubmit} noValidate>
          ...
          <div>
            ...
            <input type="radio" name="gender" id="gender1" value="Man" ref={this.genderManRef} />
            <label htmlFor="gender1">Man</label>

            <input type="radio" name="gender" id="gender2" value="Woman" ref={this.genderWomanRef} />
            <label htmlFor="gender2">Woman</label>
          </div>

          <div>
            <label>Scholarship Status: </label>
            <input type="checkbox" id="scholarship" name="scholarship" ref={this.scholarshipRef} />
